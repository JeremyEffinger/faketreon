...
-- migration_6_insert_dummy_data_users.psql
...
-- migration_7_insert_dummy_data_creators.psql
...
-- migration_8_insert_dummy_data_campaigns.psql
INSERT INTO campaigns (creator_id, title, description) VALUES (1, 'Campaign One', 'Description of campaign one');
INSERT INTO campaigns (creator_id, title, description) VALUES (2, 'Campaign Two', 'Description of campaign two');

-- migration_9_insert_dummy_data_subscriptions.psql
...
-- migration_10_insert_dummy_data_supporters.psql
